...
for ($i=1; $i<=$jmlhalaman; $i++){
  if ($i == $halaman_aktif){
   // $link_halaman .= "<li class=\"curent\"><a href=\"#\">$i</a></li>";
    $link_halaman .= "<a href=\"#\" class=\"curent\">$i</a>";
  }
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halkategoriproduk-$_GET[id]-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
...
// Fungsi untuk mencek halaman dan posisi data
function cariPosisi($batas){
if(empty($_GET['halkategoriprodukbestquality'])){
	$posisi=0;
	$_GET['halkategoriprodukbestquality']=1;
}
else{
	$posisi = ($_GET['halkategoriprodukbestquality']-1) * $batas;
}
return $posisi;
}
...
for ($i=1; $i<=$jmlhalaman; $i++){
  ...
  $link_halaman .= "<a href=halkategoriprodukbestquality-best-$i.html>$i</a> | ";
}
$link_halaman .= " ";
}
return $link_halaman;
